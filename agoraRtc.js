...
function removeVideoStream(streamId, streamOrder){
...
document.getElementById("join").onclick = function () {
    ...
    client.on("stream-removed", function (evt){
        console.log("Subscribed stream");
        let stream = evt.stream;
        if (document.getElementById("remoteStream").style.visibility == "visible") {
            removeVideoStream(stream.getId(), stream.getId(Username), "remoteStream");
        }
        else if (document.getElementById("remoteStream2").style.visibility == "visible") {
            removeVideoStream(stream.getId(), stream.getId(Username), "remoteStream2");
        }
        else if (document.getElementById("remoteStream3").style.visibility == "visible") {
            removeVideoStream(stream.getId(), stream.getId(Username), "remoteStream3");
        }
